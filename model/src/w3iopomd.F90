...
CONTAINS
  ...
  SUBROUTINE W3IOPP ( NPT, XPT, YPT, PNAMES, IMOD, MPI_COMM_IOPP )
    ...
    ELSE 
      ...
      CALL MPI_BCAST(PTLOC(1,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(PTLOC(2,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(PTIFAC(1,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(PTIFAC(2,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(PTIFAC(3,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(PTIFAC(4,1:NOPTS),NOPTS,MPI_REAL,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(1,1,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(1,2,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(1,3,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(1,4,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(2,1,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(2,2,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(2,3,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
      CALL MPI_BCAST(IPTINT(2,4,1:NOPTS),NOPTS,MPI_INTEGER,0,MPI_COMM_IOPP,IERR_MPI)
